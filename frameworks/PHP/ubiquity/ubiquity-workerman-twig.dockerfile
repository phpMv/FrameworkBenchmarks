...
RUN php composer.phar require phpmv/ubiquity-devtools:dev-master phpmv/ubiquity-workerman:dev-master twig/twig
...
COPY deploy/worker/workerServicestwig.php app/config/workerServices.php
COPY deploy/worker/configtwig.php app/config/config.php
